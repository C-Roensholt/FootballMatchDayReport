...
def plot_defensive_actions(fig, ax, def_actions, labels, team):
    ...
    ax.bar(17, 100, width=33, 
        align='center', color=[TEAM_COLORS[team]], alpha=labels_int[0]*0.01, linewidth=4)
    ax.bar(50, 100, width=33, 
        align='center', color=[TEAM_COLORS[team]], alpha=labels_int[1]*0.01, linewidth=4)
    ax.bar(83.2, 100, width=33, 
        align='center', color=[TEAM_COLORS[team]], alpha=labels_int[2]*0.01, linewidth=4)
    ...
    ax.scatter(def_actions.x, def_actions.y, 
                s=50, color=TEAM_COLORS[team], alpha=0.8, marker='h', zorder=10)
    ax.scatter(def_actions.x, def_actions.y, 
                s=150, color=TEAM_COLORS[team], alpha=0.2, marker='h', zorder=10)
